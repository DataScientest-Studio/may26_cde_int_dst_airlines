...
class DataRoutesFlight(object):
    ...
    def __init__(self, number=None):  # noqa: E501
        """DataRoutesFlight - a model defined in Swagger"""  # noqa: E501
        self._number = None
    ...
    @property
    def number(self):
        """Gets the number of this DataRoutesFlight.  # noqa: E501


        :return: The number of this DataRoutesFlight.  # noqa: E501
        :rtype: str
        """
        return self._number
    ...
    def number(self, number):
        """Sets the number of this DataRoutesFlight.


        :param number: The number of this DataRoutesFlight.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DataRoutesFlight, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DataRoutesFlight):
            return False
